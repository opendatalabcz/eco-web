...
class AverageDailyRelativeHumidityStationsSpider(scrapy.Spider):
    name = 'H_AVG_stations'
    ...
    def generateURL(self, region: str) -> str:
        if region == 'Kralovehradecky':
            region = 'hradecky'
        return 'https://www.chmi.cz/files/portal/docs/meteo/ok/denni_data/H-AVG/HTML_test/' + region.lower() + '.html'
