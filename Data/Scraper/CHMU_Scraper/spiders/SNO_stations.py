...
class HeightOfNewlyFallenSnowStationsSpider(scrapy.Spider):
    name = 'SNO_stations'
    ...
    def generateURL(self, region: str) -> str:
        if region == 'Kralovehradecky':
            region = 'hradecky'
        return 'https://www.chmi.cz/files/portal/docs/meteo/ok/denni_data/SNO-07.00/HTML_test/' + region.lower() + '.html'
