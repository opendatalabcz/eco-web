...
class MaximumWindSpeedStationsSpider(scrapy.Spider):
    name = 'Fmax_stations'
    ...
    def generateURL(self, region: str) -> str:
        if region == 'Kralovehradecky':
            region = 'hradecky'
        return 'https://www.chmi.cz/files/portal/docs/meteo/ok/denni_data/Fmax-00.00/HTML_test/' + region.lower() + '.html'
